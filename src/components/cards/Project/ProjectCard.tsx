...
import { motionStep } from '@/src/config/motion'
      ...
      <div>
        <div className='flex items-center justify-between my-5' >
          ...
          <div className={'flex justify-end items-center gap-3 text-slate-300'} >
            ...
            {code && <Link className='hover:text-sky-400 transition-all duration-300 hover:scale-90 text-[1.2rem]' href={`${code}`} target='_blank' >
              <FiGithub />
            </Link>}
