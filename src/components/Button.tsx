...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      className={`bg-slate-800 text-white no-underline group cursor-pointer relative shadow-2xl dark:shadow-zinc-900 rounded-xl p-px text-base leading-7 inline-block tracking-wide ${className}`}
      type={type}
      onClick={onClick}
    >
